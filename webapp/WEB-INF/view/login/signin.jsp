...
<header id="header">
    ...
    <section id="login">
        <div id="login">
            <p><b>ĐĂNG KÝ</b></p>
            <legend>
                <form action="/demospringmvc/dangky" method="post">
                    <input type="text" name="username" id="user" placeholder="User" required><br>
                    <input type="password" name="password" id="password" placeholder="Password" required><br>
                    <br><b>Đã Có Tài Khoản? </b><a href="/demospringmvc/dangnhap"
                        style="color: rgb(222, 17, 17);">ĐĂNG NHẬP</a>
                    <div id="button">
                        <button type="reset" id="huy"><b>HỦY</b></button>
                        <button type="submit" id="dangnhap"><b>ĐĂNG KÝ</b></button>
                    </div>
                </form>
